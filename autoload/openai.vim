...
function! openai#Complete()
	...
	let command = "curl -sSL -H 'Content-Type: application/json' -H 'Authorization: Bearer " . openai_api_key . "' -d '{\"model\": \"text-davinci-002\", \"prompt\":\"" . substitute(trim(text), '"', '\\"', "g") . "\", \"max_tokens\": 1000}' https://api.openai.com/v1/completions"
